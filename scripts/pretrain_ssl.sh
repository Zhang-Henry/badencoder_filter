...
# CUDA_VISIBLE_DEVICES=2 nohup python -u pretrain_ssl/cifar10_benchmark.py > log/clean_encoder/BYOL_cifar.log 2>&1 &

CUDA_VISIBLE_DEVICES=3 nohup python -u pretrain_ssl/cifar10_benchmark.py > log/clean_encoder/simsaim_cifar.log 2>&1 &

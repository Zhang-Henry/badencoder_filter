...
def evaluate_imagenet(gpu, encoder_usage_info, downstream_dataset, encoder, reference_label, trigger, reference, key='clean'):
    ...
    cmd = f"nohup python3 -u training_downstream_classifier.py \
            ...
            --gpu {gpu} \
            >./log/imagenet/evaluation_{key}_{downstream_dataset}9.txt 2>&1 &"
...
evaluate_imagenet(0, 'imagenet', 'gtsrb', 'output/imagenet/gtsrb_backdoored_encoder/2024-02-08-20:21:38/model_50.pth', 12, 'output/imagenet/gtsrb_backdoored_encoder/2024-02-08-20:21:38/unet_filter_50_trained.pt', 'priority', 'backdoor')

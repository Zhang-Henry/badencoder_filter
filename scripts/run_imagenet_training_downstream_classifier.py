...
def evaluate_imagenet(gpu, encoder_usage_info, downstream_dataset, encoder, reference_label, trigger, reference, key='clean'):
    ...
    cmd = f"nohup python3 -u training_downstream_classifier.py \
            ...
            --gpu {gpu} \
            --lr 0.001 \
            >./log/imagenet/evaluation_{key}_{encoder_usage_info}_{downstream_dataset}1.txt 2>&1 &"
...
### ISSBA
# evaluate_imagenet(1, 'imagenet', 'stl10', 'output/imagenet/stl10_backdoored_encoder/2024-02-03-17:58:43/model_200.pth', 9, 'xx', 'truck', 'backdoor')
# evaluate_imagenet(2, 'imagenet', 'gtsrb', 'output/imagenet/gtsrb_backdoored_encoder/2024-02-03-18:01:58/model_200.pth', 12, 'xx', 'priority', 'backdoor')
# evaluate_imagenet(3, 'imagenet', 'svhn', 'output/imagenet/svhn_backdoored_encoder/2024-02-03-18:03:39/model_200.pth', 1, 'xx', 'one', 'backdoor')
...
evaluate_imagenet(4, 'imagenet_100', 'imagenet_100', 'output/imagenet_100/imagenet_100_backdoored_encoder/2024-08-06-01:15:29/model_200.pth', 89, 'output/imagenet_100/imagenet_100_backdoored_encoder/2024-08-06-01:15:29/unet_filter_200_trained.pt', 'rottweiler', 'backdoor')
# evaluate_imagenet(1, 'byol', 'imagenet_100', 'output/byol/imagenet_100_backdoored_encoder/2024-08-06-01:15:29/model_200.pth', 25, 'output/byol/imagenet_100_backdoored_encoder/2024-08-06-01:15:29/unet_filter_200_trained.pt', 'rottweiler', 'backdoor')
# evaluate_imagenet(2, 'simsiam', 'imagenet_100', 'output/simsiam/imagenet_100_backdoored_encoder/2024-08-06-01:15:29/model_200.pth', 25, 'output/simsiam/imagenet_100_backdoored_encoder/2024-08-06-01:15:29/unet_filter_200_trained.pt', 'rottweiler', 'backdoor')

...
def evaluate_imagenet(gpu, encoder_usage_info, downstream_dataset, encoder, reference_label, trigger, reference, key='clean'):
    ...
    cmd = f"nohup python3 -u training_downstream_classifier.py \
            ...
            --gpu {gpu} \
            >./log/imagenet/evaluation_{key}_{downstream_dataset}_issba.txt 2>&1 &"
...
# evaluate_imagenet(2, 'imagenet', 'gtsrb', 'output/imagenet/gtsrb_backdoored_encoder/2023-12-23-20:22:55/model_50.pth', 12, 'output/imagenet/gtsrb_backdoored_encoder/2023-12-23-20:22:55/unet_filter_50_trained.pt', 'priority', 'backdoor')
...
### ISSBA
# evaluate_imagenet(0, 'imagenet', 'stl10', 'output/imagenet/stl10_backdoored_encoder/2024-02-03-17:58:43/model_50.pth', 9, 'output/imagenet/stl10_backdoored_encoder/2024-02-03-17:58:43/unet_filter_50_trained.pt', 'truck', 'backdoor')
# evaluate_imagenet(4, 'imagenet', 'gtsrb', 'output/imagenet/gtsrb_backdoored_encoder/2024-02-03-18:01:58/model_50.pth', 12, 'output/imagenet/gtsrb_backdoored_encoder/2024-02-03-18:01:58/unet_filter_50_trained.pt', 'priority', 'backdoor')
evaluate_imagenet(4, 'imagenet', 'svhn', 'output/imagenet/svhn_backdoored_encoder/2024-02-03-18:03:39/model_50.pth', 1, 'output/imagenet/svhn_backdoored_encoder/2024-02-03-18:03:39/unet_filter_50_trained.pt', 'one', 'backdoor')
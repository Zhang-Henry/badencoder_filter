...
def run_eval(gpu, encoder_usage_info, downstream_dataset, encoder, reference_label, trigger, reference_file, key='clean'):
    ...
    cmd = f"nohup python3 -u training_downstream_classifier.py \
            ...
            --gpu {gpu} \
            >./log/{encoder_usage_info}/evaluation_{key}_{encoder_usage_info}_{downstream_dataset}_robust10.log 2>&1 &"
...
run_eval(5, 'stl10', 'cifar10', './output/stl10/cifar10_backdoored_encoder/2024-01-05-17:08:16/model_200.pth', 0, './output/stl10/cifar10_backdoored_encoder/2024-01-05-17:08:16/unet_filter_200_trained.pt', 'airplane', 'backdoor')# color + loss0

...
def run_eval(gpu, encoder_usage_info, downstream_dataset, encoder, reference_label, trigger, reference_file, key='clean'):
    ...
    cmd = f"nohup python3 -u training_downstream_classifier.py \
            ...
            --gpu {gpu} \
            >./log/{encoder_usage_info}/evaluation_{key}_{encoder_usage_info}_{downstream_dataset}_color_loss0.log 2>&1 &"
...
# run_eval(0, 'cifar10', 'svhn', './output/cifar10/svhn_backdoored_encoder/2023-12-28-14:50:03/model_50.pth', 1, 'output/cifar10/svhn_backdoored_encoder/2023-12-28-14:50:03/unet_filter_50_trained.pt', 'one', 'backdoor')
...
# run_eval(0, 'stl10', 'cifar10', './output/stl10/cifar10_backdoored_encoder/2023-12-28-14:47:05/model_150.pth', 0, './output/stl10/cifar10_backdoored_encoder/2023-12-28-14:47:05/unet_filter_150_trained.pt', 'airplane', 'backdoor')
...
# run_eval(0, 'stl10', 'gtsrb', './output/stl10/gtsrb_backdoored_encoder/2023-12-28-14:49:58/model_100.pth', 12, './output/stl10/gtsrb_backdoored_encoder/2023-12-28-14:49:58/unet_filter_100_trained.pt', 'priority', 'backdoor')
...
run_eval(5, 'stl10', 'svhn', './output/stl10/svhn_backdoored_encoder/2023-12-28-17:03:53/model_50.pth', 1, './output/stl10/svhn_backdoored_encoder/2023-12-28-17:03:53/unet_filter_50_trained.pt', 'one', 'backdoor')
